...
**Status:** **Delivered** ✅ — P6.1 PR [#289](https://github.com/wakeuplabs-io/alpen-multisig/pull/289), P6.2 PR [#292](https://github.com/wakeuplabs-io/alpen-multisig/pull/292), P6.3 PR [#293](https://github.com/wakeuplabs-io/alpen-multisig/pull/293), P6.4 PR [#294](https://github.com/wakeuplabs-io/alpen-multisig/pull/294). §4.3.5 **PASS (regtest / dev mnemonic)**.
