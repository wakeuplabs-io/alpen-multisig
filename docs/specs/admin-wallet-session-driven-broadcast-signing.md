...
**Status:** Shipped — merged to `develop` (R1.1 complete). Evolution: [`admin-wallet-session-driven-broadcast-signing-evolution.md`](../archive/evolution/admin-wallet-session-driven-broadcast-signing-evolution.md).
