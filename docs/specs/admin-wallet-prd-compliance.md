...
**Release 1:** R1.0–R1.7 done. **Release 2:** R2.1–R2.3 done ✅. **Phase 4:** done ✅. **Phase 5:** done ✅. **Phase 6:** done ✅ (Send — regtest/dev mnemonic). **Phase 7:** done ✅ (Admin ID display/copy + receive QR & click-to-copy). **Admin ID program (PRD 06):** G7, G8 and G9 done ✅ — §4.1, §4.2 and §3.c.i all PASS, with device evidence. **Next:** Phase 8 (HW direct adapters — Send-on-HW + verify-on-device for §4.3.4.2; §4.2 is already closed by G9).
