...
V3 (Security Council signer update) has a functional contract and a build plan, and is not started;
...
| 5 | Vertical slices V1–V4 | In progress — V1 and V2 shipped; V3 specced, not started; V4 pending |
