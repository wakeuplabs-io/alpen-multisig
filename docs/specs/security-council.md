...
| 5 | Vertical slices V1–V4 | In progress — V1, V2 and V3 shipped, V3 closed out after its manual walk with AC 13 evidence deferred; V4 planned, implementation pending |
