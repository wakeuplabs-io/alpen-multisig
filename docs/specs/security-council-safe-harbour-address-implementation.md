...
**Status:** Phases 1 and 2 implemented, automated checks green. The Phase 1 manual walk produced
two findings, both fixed in Phase 2; a second walk over Phase 2's own surfaces is pending. Phase 3
is the reserve.
...
V1 needed two phases nobody planned plus four close-out PRs; V2 and V3 budgeted one each. Budget one
here and expect it to be about copy — how "safe harbour" reads to someone who has not read the PRD —
and about how the destination is displayed.
