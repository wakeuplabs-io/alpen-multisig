...
|-------|-------------|--------|
| **Slice 1 (POC-4)** | Basic flow: propose → sign → quorum (detailed below) | **Done** — see [`docs/archive/poc-specs/poc4-e2e-propose-sign-flow.md`](../archive/poc-specs/poc4-e2e-propose-sign-flow.md) |
