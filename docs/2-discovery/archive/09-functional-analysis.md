...
> **Archived (2026-04-17) — Status: Superseded.** Kept as historical record of the phase-1 functional breakdown.
>
...
> - Hardware wallet architecture → [`06-hardware-wallet-architecture.md`](../06-hardware-wallet-architecture.md), [`07-hardware-wallet-library-analysis.md`](../07-hardware-wallet-library-analysis.md), [`15-poc5-trezor-findings.md`](../15-poc5-trezor-findings.md)
> - Crate / PRD coverage → [`08-alpen-crate-prd-coverage.md`](../08-alpen-crate-prd-coverage.md)
>
> Any reference to Borsh in this document should be read as **SSZ** per the [ASM repo migration](../11-asm-repo-migration.md). Any reference to "Axum + Postgres" describes the PRD target stack; the walking skeleton runs Axum + in-memory repo (Postgres deferred, see NF-6). Other relative links inside may not fully resolve from this archive location.
