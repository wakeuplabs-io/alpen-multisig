# Evolution folder index

**Audience:** Engineers tracing what shipped after a feature merged.

Files here are **archived post-merge summaries** — narrative closure for nWave DELIVER features. They are **not** SSOT for current behavior.
