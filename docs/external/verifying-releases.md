...
The authorized public keys are published in the [`release-keys/`](https://github.com/wakeuplabs-io/alpen-multisig/tree/main/release-keys/) directory of the project repository. Import them once:
...
When multiple signatures are present, verify each one and confirm the required
