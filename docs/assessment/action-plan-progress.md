...
| W3-2 | `wave3/w3-2-coordination` | Coordination correctness | P-019, P-032 (race) | in_progress | — |
...
| P-019 | in_progress | W3-2 | Duplicate check in `add_signature` under write lock |
