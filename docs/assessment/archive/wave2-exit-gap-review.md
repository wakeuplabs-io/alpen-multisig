...
| Ops runbook + threat model + signer-safety published (internal SSOT) | **Met** | Track F — [`operations/runbook.md`](../../operations/runbook.md), [`operations/threat-model.md`](../../operations/threat-model.md), [`specs/signer-safety-model.md`](../../specs/signer-safety-model.md) |
