...
| Ops runbook + threat model + signer-safety published (internal SSOT) | **Met** | Track F — [`operations/runbook.md`](../operations/runbook.md), [`security/threat-model.md`](../security/threat-model.md), [`specs/signer-safety-model.md`](../specs/signer-safety-model.md) |
