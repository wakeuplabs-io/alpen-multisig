...
fn main() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::hw_wallet::list_ledger_addresses,
            commands::hw_wallet::get_ledger_info,
            commands::hw_wallet::sign_with_ledger,
            commands::hw_wallet::sign_challenge_with_ledger,
