	...
	if (txs.length === 0) {
		return (
			<div className="rounded-xl border border-[#e5e7eb] bg-white px-6 py-12 text-center">
				...
				<p className="m-0 font-['BIZ_UDPMincho'] text-[18px] text-[#0a0a0a]">No past transactions</p>
				<p className="m-0 mt-1.5 text-[13px] text-[#6b7280]">Broadcast transactions will appear here.</p>
			</div>
		)
	}
	...
	return (
		<div className="flex flex-col gap-2.5">
			<div className="grid grid-cols-[1fr_auto_auto_auto] gap-4 px-5 pb-1">
				<span className="text-[11px] font-semibold uppercase tracking-wider text-[#9ca3af]">Transaction ID</span>
