...
import { SEND_DESTINATION_UNAVAILABLE_COPY, formatSendDestinationError } from '../format-send-error.ts'
...
console.log('format-send-error.test.ts PASS (PRD §4.3.5.1 copy byte-exact)')
