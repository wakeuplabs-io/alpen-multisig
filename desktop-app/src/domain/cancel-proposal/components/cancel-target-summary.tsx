  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#e5e7eb] bg-white shadow-sm">
      <div className="border-b border-[#f3f4f6] px-6 py-4">
        <p className="m-0 text-[11px] font-semibold uppercase tracking-wider text-[#9ca3af]">Proposal being cancelled</p>
      </div>

      <div className="px-6 py-5 space-y-1">
        <p className="m-0 text-[15px] font-medium text-[#0a0a0a]">
          {changeLabel ?? `Proposal #${proposal.seqNo}`}
        </p>
