...
export async function getChallenge(signerPubkey: string, authority: string): Promise<ApiResult<AuthChallenge>> {
...
export async function createSession(payload: CreateSessionPayload): Promise<ApiResult<SessionInfo>> {
