...
├── 2-discovery/        # Research, ecosystem understanding, and POC plans/results (historical)
├── 3-stories/          # Story map and non-functional items
├── architecture/       # System architecture overview
│   └── adrs/           # Architecture Decision Records
├── specs/              # Feature specs generated by the SDD workflow
├── feature/            # nWave DELIVER artifacts (roadmap.json, feature-delta)
├── evolution/          # Archived feature summaries post-merge
├── assessment/         # Backlog and wave tracking (SSOT: deferred-backlog, action-plan-progress)
